...
for pop in pops:
  print(pop)
  fname = '/home/abortvi2/scr16_rmccoy22/abortvi2/pyrho_1kgp_chm13_unphased/final/' + pop + '_chr' + str(chromosome) + '.tsv'
...
outName = 'averagedByBase/chr' + str(chromosome) + '.txt'
f = open(outName, 'w')
