...
in_name <- paste0('/home/abortvi2/scr16_rmccoy22/abortvi2/pyrho_1kgp_chm13_unphased/opt_params_masked_masked/', pop, '_chr', chr, '_w', window, '_b', penalty, '_masked_masked.rmap')
...
out_name <- paste0('/home/abortvi2/scr16_rmccoy22/abortvi2/pyrho_1kgp_chm13_unphased/final/', pop, '_chr', chr, '.tsv')
